          ...
          <div class="flex gap-6 text-sm">
            <a href="https://t.me/+c-2Jv_ESv-Y1MjQ6" type="button" target="_blank" rel="noopener noreferrer"
              ...
              <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="250" height="250" viewBox="0 0 50 50" fill="white">
            ...
            <a href="mailto:cr.urfubest@gmail.com" type="button" target="_blank" rel="noopener noreferrer"
              class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900">
              <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="256" height="256" viewBox="0 0 256 256" fill="white">
            ...
            <a href="https://vk.com/most_urfu" type="button" target="_blank" rel="noopener noreferrer"
              class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900">
              <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="250" height="250" viewBox="0 0 50 50" fill="white">
