...
export class BoardMembersListComponent {
  ...
  boardMembers: BoardMember[] = [
    ...
    { id: 3, name: this.lang.t['treasurer'], position: 'Treasurer', role: this.lang.t['treasurerRole'], board: this.lang.t['boardXXII'], image: '/images/Jenya.jpg', social: [{ type: 'vk', url: 'https://vk.com/homutinnikova', icon: 'vk' }, { type: 'telegram', url: 'https://t.me/zececka', icon: 'telegram' }] },
