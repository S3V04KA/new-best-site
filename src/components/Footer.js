...
const Footer = () => {
  return (
      <footer id="contacts" className="bg-[#1c1c1c] text-white p-12 md:p-20 border-t-4 border-black">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
          <div>
            <div className="text-3xl font-black tracking-tighter mb-3 uppercase">ART OF ARCH</div>
            <p className="text-sm text-gray-400 max-w-sm">
              Экспериментальное объединение и полигон для лучших архитектурных умов будущего.
            </p>
          </div>
          <div className="flex flex-col gap-3 font-bold">
            <span className="text-xs uppercase text-gray-500 tracking-widest">Контакты для связи</span>
        ...
        <div className="max-w-6xl mx-auto mt-12 pt-6 border-t border-gray-800 text-xs text-gray-500 flex justify-between">
          <span>© {new Date().getFullYear()} Copyright: МОСТ Ekaterinburg UrFU</span>
        </div>
      </footer>
  );
};
